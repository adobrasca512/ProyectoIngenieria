...
public class Vcrearcuenta extends JFrame {
	...
	public Vcrearcuenta() {
		...
		btnEntrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String matriz[][] = prueba.getlectura_csv(rutafinal1);
					...
					prueba.getescribirenFichero(rutafinal1, clientesinfo.incluirClientes(matriz, nombres, apellidos, correos,
							ciudades, paises, Integer.parseInt(telefonos), Integer.parseInt(cp), identificacion));

					
					//String rutas = "/Users/adilemdobras/Documents/Programacion/Proyectos/fichero-de-cuentasyusuarios.txt";
					String rutasrelat = "fichero-de-cuentasyusuarios.txt";
					File fila= new File(rutasrelat);
					
		             //Path rutarelativa=Paths.get(rutasrelat);
		            // Path rutasabsoluta=rutarelativa.toAbsolutePath();
		            String rutafinal=String.valueOf(fila.getAbsolutePath());
		            System.out.println(rutafinal);
					String[][] matrizNueva = prueba.getlectura_csv(rutafinal);
		...
		lblNewLabel.setIcon(new ImageIcon(
				Vcrearcuenta.class.getResource("/Imagen/Captura de Pantalla 2020-05-11 a la(s) 3.37.38 p. m..png")));
