		...
		btnEntrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			  ...
			  //  Path rutabsoluta1=rutarelativa1.toAbsolutePath();
			   String rutafinal1=String.valueOf(fichero.getAbsolutePath()); 
				System.out.println(rutarelativa1.toString());
				// le di un tamaño al fichero
				String[][] matriz = prueba.getlectura_csv(fichero.getAbsolutePath());
				// Realizo la escritura del fichero para que añada a los usuarios
			//	File file = new File(rutafinal1);
				String data = "";
				...
				while (!encontrado && i < matriz.length) {
					if (txtUsuario.getText().equals(matriz[i][0])) {
						...
						if (passwordField.getText().equals(matriz[i][1])) {
							...
							Path rutarelativa2=Paths.get(rutas);
						   ...
						   String rutafinal2=String.valueOf(rutabsoluta2);
							...
							String matrizalmacen[][] = prueba.getlectura_csv(rutafinal2);
							Comprascliente compras = new Comprascliente(prueba, "", "", 0, 0, matrizalmacen, rutafinal2);
