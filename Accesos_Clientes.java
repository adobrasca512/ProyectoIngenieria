...
public class Accesos_Clientes {
	...
	Path rutarelativa1=Paths.get(rutas);
   ...
   String rutafinal1=String.valueOf(rutabsoluta1);
	...
	Path rutarelativa2=Paths.get(rutausuario);
    Path rutabsoluta2=rutarelativa1.toAbsolutePath();
   String rutafinal2=String.valueOf(rutabsoluta2);
	public Accesos_Clientes(String nombre, String apellido, String correo, String pais, String ciudad, int telefono,
		...
		this.matrizUsuarios = usuario.getlectura_csv(rutafinal2);
	}

	public void getImprimirdatos(int posicion) {
		// String rutas = "tableconvert_csv_0xo8do.csv";
		String[][] matriz = usuario.getlectura_csv(rutafinal1);
